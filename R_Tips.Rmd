...
Combining the `geom_rect` and `geom_text` functions in `ggplot2` is a really great way to highlight regions of interest in a plot. For example, let's look at the birth rate in Scotland in the 20th century ([source](https://www.nrscotland.gov.uk/statistics-and-data/statistics/statistics-by-theme/vital-events/births/births-time-series-data)).
