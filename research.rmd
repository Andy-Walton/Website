...
## Population Genetics and Continuous Space Modelling

![](Images/plot.jpg){.in-text-image}

Many of the models in Population Genetics are based around the panmictic population concept. In other words, often, contain assumptions of random mating, infinite population size, no migration etc. However, in nature, these assumptions are rarely the case. I'm interested in developing new models which move away from these, such as modelling populations in continuous space.
